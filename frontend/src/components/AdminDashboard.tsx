...
interface DbInfo { reachable: boolean; backend: string; error?: string }
...
function MonitoringTab({ token }: { token: string }) {
...
type TabKey = 'dashboard' | 'tickets' | 'customers' | 'satisfaction' | 'notifications' | 'rbac' | 'channels' | 'sessions' | 'agent' | 'health' | 'monitoring' | 'config' | 'evaluation' | 'workflow' | 'knowledge'
